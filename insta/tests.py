...
class TestImages(TestCase):
  ...
  def setUp(self):
    ...
    '''
    self.test_user = User(username = 'larv')
    self.test_user.save()
    self.image = Image(image = 'larv.jpeg',name = 'larv',caption = 'larv',user = self.test_user)
    self.comments = Comment(comment = 'great',image = self.image,user = self.test_user)
  ...
  def test_delete_image(self):
    self.image2 = Image(image = 'moraa.jpeg',name = 'moraa',caption = 'moraa',user = self.test_user)
